...
const ReplyPreview: React.FC<{
  ...
  return (
    <div
      ...
      }${onPress ? ' cursor-pointer hover:opacity-80 transition-opacity' : ''}`}
      onClick={onPress}
    >
...
const MessageItem = React.memo(function MessageItem({
  ...
  return (
    <div className="animate-fade-in" data-message-id={message.id}>
              ...
              <ReplyPreview
                ...
                onPress={
                  message.replyMessage.id
                    ? () => onScrollToMessage?.(message.replyMessage!.id)
                    : undefined
                }
              />
            )}
...
> = ({
  ...
  // Scroll to the message element with the given ID (used by reply-quote clicks)
